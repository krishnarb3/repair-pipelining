...
/**
 * A wrapper of block level data source/output that can be
...
public class ECBlock {
     ...
     * @param isErased is erased or not
     */
    public ECBlock(ECChunk chunk, boolean isParity, boolean isErased) {
        this.chunk = chunk;
        this.isParity = isParity;
        this.isErased = isErased;
    }
    ...
    public ECChunk getChunk() {
        return chunk;
    }

    public void setChunk(ECChunk chunk) {
        this.chunk = chunk;
    }
}
